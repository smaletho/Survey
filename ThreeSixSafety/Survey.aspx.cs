...
namespace ThreeSixSafety
{
    public partial class Survey : System.Web.UI.Page
    {
        ...
        protected void parseQuestions()
        {
            ...
            TextFieldParser parser = new TextFieldParser(@"C:\inetpub\wwwroot\ThreeSixSafetySurvey\Questions.csv", System.Text.Encoding.GetEncoding("ISO-8859-1"));
        ...
        protected void submitVals()
        {
            ...
            string path = @"C:\inetpub\wwwroot\ThreeSixSafetySurvey\Answers.csv";
            if (File.Exists(path))
            {
